...
if(isset($_POST['sign-up'])){
    ...
    if($password != $cpassword){
        ...
        $insert = "INSERT INTO customer (email,password,firstname,lastname,address,phone) VALUES
        ...
        <form class="max-w-md mx-auto" method="POST">
            ...
            <?php 
                ...
                foreach($error as $errors){
                    ...
                    echo '<span class="error-msg"> - ' . $errors . '</span><br>';
            ...
            <button type="submit" name="sign-up" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
        </form>
